...
const login = (loginDetails, cookies) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (user && isMatched) {
            ...
            const accessToken = (0, authorize_1.createToken)({ id: user._id, name: user.name, role: user.roleId }, process.env.ACCESS_TOKEN_SECRET || '', '1d');
            const refreshToken = (0, authorize_1.createToken)({ id: user._id }, process.env.REFRESH_TOKEN_SECRET || "", '365d');
